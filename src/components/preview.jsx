...
export function Preview() {
  ...
  function preview() {
    ...
    const icons = document.querySelectorAll(".modifyFieldWrapper");
    const addItemsBtns = document.querySelectorAll(".add_item_btn");
    const unselectItemWrapper = document.querySelectorAll(".unselect_item_wrapper");
